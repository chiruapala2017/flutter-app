...
internal class NativeViewFactory(private val activity: Activity) : PlatformViewFactory(StandardMessageCodec.INSTANCE) {
    ...
    var streamingPreset: Camera.ResolutionPreset = Camera.ResolutionPreset.low
    var enableOpenGL: Boolean = false

    var dartMessenger: DartMessenger? = null

    override fun create(context: Context, id: Int, args: Any?): PlatformView {
        cameraNativeView = CameraNativeView(activity, enableAudio, preset, cameraName, dartMessenger, streamingPreset, enableOpenGL)
