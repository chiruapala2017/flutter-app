...
class CameraNativeView(
        ...
        private var streamingPreset: Camera.ResolutionPreset,
        private var enableOpenGL: Boolean = false) :
        PlatformView,
    ...
    fun startVideoStreaming(url: String?, result: MethodChannel.Result) {
        ...
        try {
            if (!rtmpCamera.isStreaming) {
                val streamingSize = CameraUtils.getBestAvailableCamcorderProfileForResolutionPreset(cameraName, streamingPreset)
