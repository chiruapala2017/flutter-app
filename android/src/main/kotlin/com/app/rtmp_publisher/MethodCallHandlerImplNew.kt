...
class MethodCallHandlerImplNew(
    ...
    private fun instantiateCamera(call: MethodCall, result: MethodChannel.Result) {
        handler.postDelayed({
            ...
            var streamingPresetStr = call.argument<String>("streamingPreset") ?: "low"
            var streamingPreset = Camera.ResolutionPreset.valueOf(streamingPresetStr)
            ...
            nativeViewFactory?.enableOpenGL = enableOpenGL
            nativeViewFactory?.streamingPreset = streamingPreset
